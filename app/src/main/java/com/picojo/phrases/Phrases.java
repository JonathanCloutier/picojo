...
public class Phrases {
    ...
    public static void reset() {
        ...
        //Actions
        add("%s tu peux doubler 1 fois max %d gorgée", 12);
        add("%s si tu a bu plus q'une 24 dans la derniere semaine chug. A partir de dimanche", 1);
        add("%s dit le nom complet de tout le monde qui joue ou prend %d gorgé", 5);
        ...
        add("%s si tu est jamais aller au mephisto boit %d gorgées", 6);
        add("%s vériter ou conséquence", 1);
        add("%s texte ta maman que tu l'aime vraiment beaucoup", 1);
        add("%s fait un massage a ton voisin de gauche ou prend %d gorgées", 4);
        add("La dernière personne châpeau pointu s'assis par terre pour 6 questions", 1);
        add("La plus grande personne prend %d gorgées", 4);
        ...
        add("Prend %d gorgées si t'es déjà aller au Méphisto", 3);
        ...
        add("Tous ceux qui ont fait un arbre de noel cette année prennent %d gorgées", 3);
        ...
        add("Si tu déjà a perdu ton cellulaire et que tu ne la jamais retrouver prend %d gorgées sinon distribu %d gorgées", 3);
        add("%s choisi un objet dans la pièce. Le premier a y touché distribu %d gorgées", 4);
        add("%s distribue autant de gorgées que tu a fini de consommation", 1);
        add("La premiere personne a licher son coude distribue %d gorgées", 6);
        add("%s distribue 2 gorgées ou laisse %s prendre %d gorgées", 3);
        ...
        add("Si tu n'a jamais pass-out, prend %d gorgées", 3);
        add("%s choisi une couleur. Tout ceux qui ont un vetement de cette couleur prennent %d gorgées", 2);
        add("La personne la plus petite distribue %d gorgées", 3);
        add("La premiere personne a identifé le joueur le plus jeune distribu %d gorgées", 5);
        ...
        add("%s nomme une chose que tu na jamais fait. Tout ceux qui l'on déjà fait prennent %d gorgées", 4);
        add("La dernière personne qui a pris l'avion distribue %d gorgées.", 3);
        add("%s, tu a 3 secondes pour dire le nombre de personne présebt dans la piece. Prend %d gorgées en cas d'éhcec.", 5);
        add("%s dit une phrase d'un filme, le premier a devenier le film distribue %d gorgées.", 2);
        add("Le DJ distribue %d gorgées.", 3);
        add("%s donne %d gorgées a la personne que tu connais le mieux.", 2);
        add("Prend %d gorgées si tu a déja travailler dans un camp d'été", 3);
        ...
        add("%s, si tu a coucher avec plus de 5 personnes prend %d gorgées", 4);
        ...
        add("%s laisse %s refaire ta coupe de cheuveux ou prend 3 gorgées", 1);
        add("Pendant 5 minutes, %s parle avec un accent congolais ou prend %d gorgées", 6);
        add("%s fait un massage a %s ou prend %d gorgées", 4);
        add("%s fait la larve ou prend %d gorgées", 4);
        add("%s choisi une chanson et fait une chorégraphie puis distribue 6 ou prend %d gorgées", 4);
        add("%s dévoile une de tes addictions ou prend ou prend %d gorgées", 4);
        add("%s fait un grand écart  ou prend %d gorgées", 2);
        ...
        add("Le dernier a mettre son pouce sur la table après %s prend %d gorgées", 5);
        ...
        add("Celui qui fait le plus de push-ups entre %s et %s distribue %d gorgées", 6);
        add("%s %s Roche papier ciseaux. Le perdant prend %d gorgées", 2);
        ...
        add("Vérité ou conséquence: %s commence vers sa droite. Le premier qui refuse prend %d gorgées.", 4);
        ...
        add("Bras de fer entre %s et %s, le perdant prend %s gorgées", 3);

        //Votes
        add("Vote: Le plus dangereux entre %s et %s prend %d gorgées", 3);
        add("Vote: Le moins sportif prend %d gorgées", 4);
        add("Vote: Écouter un films en boucle ou une chanson en boucle pendant 1 journée? Les perdants prennent %d gorgées", 3);
        add("Vote: Qui a la plus belle coupe de cheveux entre %s et %s. Le perdant prend 2 gorgées. Le gagnant distribue %d gorgées", 2);
        add("Vote: Ne plus avoir besoin de dormir ou ne plus avoir besoin de travailler? Les perdants prennent %d gorgées.", 3);
        add("Vote: Préfèrais tu travailler pour la NASA ou Google? Les perdants prennent %d gorgées.", 3);
        add("Vote: Un monde sans musique ou sans films? Les perdants prennent %d gorgées.", 3);

        //Règles
        add("Règle: Le prochain qui regarde son cell prend %d gorgées", 4);
        add("Règle: Le prochain qui dit 'bière' prend %d gorgées", 4);
        add("Règle: Le prochain qui va au toilette prend %d gorgées", 6);
        add("Règle: Le prochain qui parle a %s prend %d gorgées", 3);
        add("Règle: %s le prochain a te regarder dans les yeux prend %d gorgées.", 4);
        add("Règle: Pendant 30 minutes, chaque fois que %s dit 'marco', %s doit répondre 'polo' sinon il prend %d gorgées", 2);
        add("Règle: Pendant 10 minutes, chaque fois que %s parle a %s ou %s, il prend %d gorgées", 3);
        add("Règle: Pendant 5 minutes, %s parle avec un accent congolais ou prend %d gorgées", 6);
        add("Règle: Pour les 3 prochaines question, les gorgées prise et distribuer sont inversé.", 1);
        add("Règle: Pour les 3 prochaines question, les gorgées sont doublées.", 1);
